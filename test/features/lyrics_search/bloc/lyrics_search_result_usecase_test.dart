...
main() {
  group('LyricsSearchResultUseCase tests', () {
    ...
    test('testing lyricsSearchEntity creation', () async {
      ...
      LyricsSearchResultUseCase useCase = LyricsSearchResultUseCase((viewModel) {
        final _scope =
        ...
        expect(viewModel, isA<LyricsSearchResultViewModel>());
      });
      useCase.create();
    });
  });
